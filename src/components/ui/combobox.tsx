...
>(({ className, placeholder, ...props }, ref) => {
  ...
  return (
    <PopoverPrimitive.Trigger
      ref={ref}
      className={cn(
        "flex h-10 w-full items-center justify-between rounded-md border border-slate-200 bg-white px-3 py-2 text-sm transition-all placeholder:text-slate-400 focus:outline-none focus-visible:border-brand-blue focus-visible:ring-1 focus-visible:ring-brand-blue data-[state=open]:border-brand-blue data-[state=open]:ring-1 data-[state=open]:ring-brand-blue disabled:cursor-not-allowed disabled:opacity-50",
        className
      )}
      {...props}
    >
